...
object CaseClasses {
  /**
    ...
    *
    * TODO figure why this doesn't work for 2.10 (despite the fact that the provenance suggests that it should).
    */
  def caseClassParamsOf[T: TypeTag]: ListMap[String, Option[Type]] = ListMap()
